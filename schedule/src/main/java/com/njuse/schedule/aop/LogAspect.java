package com.njuse.schedule.aop;
...
public class LogAspect {
    ...
    @Pointcut("within(com.njuse.schedule.controller.*)")
//    @Pointcut("execution(public * com.njuse.schedule.controller.*.*(..))")等价于上面一句
    public void webLog(){}
    ...
    @Before("within(com.njuse.schedule.service..*)&&@annotation(loggerManage)")
